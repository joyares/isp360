        ...
        <div class="content">
          ...
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="<?php echo $basePath; ?>/index.php">
              <div class="d-flex align-items-center"><img class="me-2" src="<?php echo $basePath; ?>/assets/img/icons/spot-illustrations/falcon.png" alt="" width="40" /><span class="font-sans-serif text-primary">isp360</span></div>
            </a>
              ...
              <li class="nav-item dropdown"><a class="nav-link pe-0 ps-2" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-caret dropdown-menu-end py-0" aria-labelledby="navbarDropdownUser">
                  <div class="bg-white dark__bg-1000 rounded-2 py-2">
                    ...
                    <a class="dropdown-item" href="<?php echo $basePath; ?>/pages/user/profile.php">My Profile</a>
