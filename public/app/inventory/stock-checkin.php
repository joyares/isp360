...
$alert = null;
$currentPath = $_SERVER['PHP_SELF'] ?? '/app/inventory/stock-checkin.php';
...
if (isset($_GET['ajax_get_serials'])) {
    ...
    // For checkin, we usually want to see serials that are currently NOT in stock (Checked Out)
        ...
        try {
            ...
            foreach ($rawItems as $item) {
                ...
                foreach ($serials as $sId) {
                    ...
                    // Update serial status BACK TO AVAILABLE (1)
                    $stmt = $pdo->prepare('UPDATE inventory_serial_numbers SET status = 1 WHERE serial_id = :sid');
...
<nav class="mb-2" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Stock Checkin</li>
  </ol>
</nav>

<div class="mb-4">
    <h2 class="text-bold">Stock Checkin</h2>
    <p class="text-600">Return items to inventory from customers or staff members.</p>
</div>
...
<form method="post" action="<?= $currentPath ?>" id="checkinForm">
                ...
                <div class="card-footer bg-body-tertiary">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-end d-flex align-items-end justify-content-end gap-2">
                             <button class="btn btn-primary" type="submit">Complete Checkin</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="purpose" required>
                            ...
                            <option value="Return from Staff">Return from Staff</option>
...
(function() {
    ...
    function buildRow(idx) {
        ...
        <div class="op-row border-bottom p-3" data-idx="${idx}">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-md-4">
                    <label class="form-label fs-11">Available for Return (Checked Out)</label>
    ...
    window.loadSerials = function(idx) {
        ...
        fetch(`${window.location.pathname}?ajax_get_serials=1&product_id=${pId}`)
            .then(r => r.json())
            .then(data => {
