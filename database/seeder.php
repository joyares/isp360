...
// ─────────────────────────────────────────────
// STEP 4 — Companies & Branches
// ─────────────────────────────────────────────

seeder_log('');
seeder_log('=== STEP 4: Companies & Branches tables ===');

run($pdo, 'CREATE TABLE companies', "
...
ensure_column($pdo, 'customers', 'username', 'username VARCHAR(120) NULL AFTER customer_id');
ensure_column($pdo, 'customers', 'phone_no', 'phone_no VARCHAR(30) NULL AFTER username');

// ─────────────────────────────────────────────
// STEP 6 — Support Desk tables
// ─────────────────────────────────────────────

seeder_log('');
seeder_log('=== STEP 6: Support Desk tables ===');

run($pdo, 'CREATE TABLE support_ticket_categories', "
...
run($pdo, 'CREATE TABLE support_ticket_priorities', "
...
run($pdo, 'CREATE TABLE support_ticket_statuses', "
...
run($pdo, 'CREATE TABLE support_tickets', "
...
run($pdo, 'CREATE TABLE support_ticket_notes', "
...
$pdo->exec("
    ...
    ('General', 40, 1)
");
seeder_log('  [OK]  Seeded support ticket categories');
...
$pdo->exec("
    ...
    ('Urgent', '#dc3545', 40, 1)
");
seeder_log('  [OK]  Seeded support ticket priorities');
...
$pdo->exec("
    ...
    ('Closed', 40, 1)
");
seeder_log('  [OK]  Seeded support ticket statuses');
